...
def join_data_on_address_GPS(radius=40, df=None):
    ...
    class r_closest_EAS(BallTree):
        ...
        def search_around(self, lon=None, lat=None, address=None, radius=None):
            ...
            if found_addresses == []:
                ...
                return {'EAS': None, 'Address_match': None, 'Score': None}
            ...
            if closest_eas is None:
                print('None found')
            return {'EAS': closest_eas, 'Address_match': closest_address, 'Score': score}
    ...
    def unpack_and_merge(df, eas_series, fillna=None):
        ...
        ret.rename(columns={'Address_match':'Address'}, inplace=True)
        return ret
